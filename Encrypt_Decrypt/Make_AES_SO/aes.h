...
public:
	...
	void Encrypt(char const* dataIn, char* dataResult, size_t dataLen, int iMode = ECB);
	void Decrypt(char const* dataIn, char* dataResult, size_t dataLen, int iMode = ECB);
